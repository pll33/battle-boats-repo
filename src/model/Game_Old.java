...
public class Game_Old {
	...
	public Game_Old(String player1name, String player2name, int width, int height,
			ArrayList<Integer> boatSizes) {

		this(player1name, player2name, width, height, boatSizes, false);
	}
	
	public Game_Old(String player1name, String player2name, int width, int height, ArrayList<Integer> boatSizes, boolean vsComputer, boolean hostGame){
